...
function process_image_400($dir, $filename) {
...
function process_image_700($dir, $filename) {
    ...
    // Set up the write paths
    $image_path_700 = $dir . $image_name . '_700'. $ext;
//    $image_path_100 = $dir . $image_name . '_100' . $ext;
    $image_name_700 = $image_name . '_700' . $ext;
    // Create an image that's a maximum of 400x300 pixels
    resize_image($image_path, $image_path_700, 800, 600);

    return $image_name_700;
    // Create a thumbnail image that's a maximum of 100x100 pixels
//    resize_image($image_path, $image_path_100, 100, 100);
}
