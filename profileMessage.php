...
$inc_msg = TravelDatabase::getMessages($_SESSION['joinMeTravel']);
    ...
    if(isset($_GET['submit'])){
        ...
        if(trim($_GET['message'])==''){
            ...
            header("Location:profileMessage.php");
        }
    }
    ...
    <div class="site-container">
            ...
            <div class="profileBox">
                ...
                <form method="get" action="">
                    ...
                    <div class="row" >
                        <div class="col-sm-12 col-xs-12" id="messageHeader">
                            <span id="date"><?php echo date_format(new DateTime($im['date']), 'g:i a \o\n jS F Y');?></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2 col-xs-2" style="margin-top: 1.5%; font-size: 15px">
                            <b><?php echo $im['user_firstname'];?> <?php echo $im['user_lastname'];?></b>
                        </div>
